  ...
  return (
    ...
    <div className='conteiner'>  
        <div className="conteiner_tex">
            ...
            En busca de nuevas experiencias y retos, Luigi se trasladó a España, donde encontró en Tagliatella el lugar perfecto para compartir su pasión por la cocina italiana con un público internacional. Como chef principal de Tagliatella, Luigi ha sido fundamental en la creación de un menú que refleja la riqueza y diversidad de la gastronomía italiana, combinando clásicos tradicionales con toques modernos que deleitan a los comensales.
            Luigi se enorgullece de su herencia napolitana y se esfuerza por llevar un pedazo de Italia a cada plato que sirve. Su dedicación, creatividad y amor por la cocina se reflejan en cada bocado, haciendo de una comida en Tagliatella una experiencia inolvidable para todos los que tienen el placer de disfrutar de sus creaciones.
